...
from models.financetest.finance_detail import *
...
class FinanceTest:
    ...
    def getExcelList(self,data_list):
        try:
            source_path = 'resource_api/finans/konteyner_islem/sablonlar/finans_test_list.xlsx'
            target_path = 'resource_api/finans/konteyner_islem/dosyalar/finans_test_list.xlsx'
            ...
            for item in data_list:
                ...
                sayfa.cell(satir,column=8,value=(self.__noneControl(item['forwarding']) - self.__noneControl(item['paid'])))
